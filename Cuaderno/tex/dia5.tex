...
% \hyperdef{}{}{\subsection{\texorpdfstring{{¿Cómo sabes donde
% estas?}}{¿Cómo sabes donde estas?}}}

% {LocationSensor}{~comunica con los satélites GPS y otros mecanismos para
% determinar la ubicación de tu teléfono y tablet. }
...
% \hyperdef{}{}{\subsubsection{\texorpdfstring{{Ejemplo 1. Como muestras
% tu latitude, longitude y dirección
% actual?}}{Ejemplo 1. Como muestras tu latitude, longitude y dirección actual?}}}

% {~~~~~~~~~~~~~~~~~}{\includegraphics{images/image87.png}}{~~~~~~~~~~~~~~~~~
% }{\includegraphics{images/image78.png}}{~~~~~~~~~~~~~~~~~}

% {El evento }{LocationSensor.LocationChanged}{~se activa cuando:}

% {1) por la primera vez la aplicación obtiene una lectura desde los
% satélites GPS u otros mecanismos,}

% {2) la ubicación del teléfono o tablet cambia. Si estás caminando,
% podría activarse varias veces. }

% {}

% {Nota que puedes controlar la frecuencia de activación de
% LocationChanged con las propiedades de }{LocationSensor.TimeInterval}{~y
% }{LocationSensor.DistanceInterval}{. }{TimeInterval}{~está fijado a
% 60.000 ms (1 minuto), por defecto. Eso quiere decir que
% }{LocationChanged}{~será activado de nuevo solamente después de un
% minuto.}

% {~~~~~~~~}

% {En el ejemplo, las lecturas de ubicación están mostradas en etiquetas
% (labels). Latitude y longitude son números, mientras la propiedad
% }{currentAddress }{provee una dirección (con calle, avenida, etc.) para
% tu actual ubicación. Si caminasveráss los números y la dirección
% cambiar.}{~~~~~~~~~~~~~~~~}

% \hyperdef{}{}{\subsubsection{\texorpdfstring{{Exemplo 2. Como sabes lo
% lejos que estás de un punto
% dado?}}{Exemplo 2. Como sabes lo lejos que estás de un punto dado?}}}

% {~~~~~~~~~~~~~~~~}{\includegraphics{images/image99.png}}{~~~~~~~~~~~~~~~~~}{\includegraphics{images/image38.png}}{~~~~~~~~~~~~~~~~~}

% {App Inventor no provee un block ``distancia'' para calcular la
...
% consiste en crear tu propio block - una procedura - y conectarlo a las
% fórmulas conocidas. Una vez que tienes la procedura distancia, puedes
% llamarla al final del gestionador de evento LocationChanged. Este
% ejemplo calcula la distancia entre tu ubicación actual y el campus de la
% Universidad de San Francisco.~~~~~~~~}

% \hyperdef{}{}{\section{\texorpdfstring{{Leer y contestar a los
% sensores}}{Leer y contestar a los sensores}}}

% {Apunta tu telefono al cielo y Google Sky Maps te dice que estrella
% estas mirando. }

% {Inclina tu teléfono y puedes controlar el juego al cual estás jugando.
% Lleva tu teléfono mientras estás corriendo y una aplicación puede
% registrar tu trayecto. Todas estas aplicaciones son posibles porque los
% equipos móviles que tenemos tienen sensores de alta tecnología para
% detectar nuestra ubicación, orientación y aceleración. }

% {Hoy día, exploraremos los componentes de App Inventor LocationSensor,
% OrientationSensor, y AccelerometerSensor. Durante el día, aprenderás
% sobre GPS, mediciones de orientación y algo de matemática para procesar
% las lecturas del acelerómetro.}

% {}

% {\includegraphics{images/image105.png}}

% \hyperdef{}{}{\section{\texorpdfstring{{Creando aplicaciones basadas en
% la ubicación}}{Creando aplicaciones basadas en la ubicación}}}

% {Hasta la popularización del smartphone, computación era limitada a los
% computadores de escritorio. Bueno, laptops son móviles, pero no en el
% mismo sentido que pequeño equipos que podemos poner en nuestros
% bolsillos. Computación ha dejado las oficinas y los laboratorios y se
% está moviendo afuera en todo el mundo.}

% {Un efecto significante de llevar nuestro equipo de computación con
% nosotros es nueva y muy interesante data: la ubicación actual. Saber
% donde la gente se encuentra mientras se está moviendo en el mundo tiene
% grandes implicaciones y el potencial de ayudarnos en nuestras vidas.
% También tiene el potencial de invadir nuestra privacidad y ser al
% detrimento de la humanidad.}

% {La aplicación ``Android, dónde está mi auto?'' es un ejemplo de una
% aplicación basada en la ubicación que trae beneficio personal. Esta
% aplicación es privada, tu información de ubicación está almacenada
% únicamente en la base de datos de tu teléfono. }

% {Medición de ubicación puede también ser utilizada por grupos. Por
% ejemplo, un grupo de personas que está haciendo un trekking podría
% querer seguir los movimientos de los otros en la montaña, o colegas de
% trabajos podrían querer poder encontrarse en una grande conferencia.
% Algunas personas utilizan este tipo de aplicación ``check-in'' todos los
% días.}

% {Otro tipo de aplicación basada en la ubicación utiliza herramientas de
% realidad aumentada. Estas aplicaciones utilizan tu ubicación y la
% orientación de tu teléfono para proveer extra-información que aumenta
% los ajustes naturales. Podrías apuntar tu teléfono hacia un edificio y
% ver el precio del mercado inmobiliario, o podrías caminar cerca de una
% planta exótica en un jardín y ver cual especie es con tu aplicación. }

% \hyperdef{}{}{\subsection{\texorpdfstring{{GPS}}{GPS}}}

% {Para crear aplicaciones basadas en la ubicación, primero tienes que
% entender como el GPS (}{global positioning system - sistema de
% posicionamiento global}{) funciona. Datos GPS vienen de un sistema de
% satélites mantenido por el gobierno estadounidense. Siempre y cuando
% existe una vista despejada de al menos 3 satélites en el sistema, tu
% teléfono puede obtener una lectura. Una lectura GPS consiste en tu
% latitud, longitud y altitud. Latitud es cuanto lejos del ecuador hacia
% el norte o el sur te encuentras, con valores positivas hacia el norte y
% negativas hacia el sur. La gama de valores es de -90 a 90. La Figura
% 23-1 muestra un mapa Google de un lugar cerca de Quito, capital del
% Ecuador. La Latitud mostrada en el mapa es -0.01, apenas al sur del
% ecuador (Quito, Ecuador, is on the equator)!}
...
% {Longitud es cuanto lejos del primer meridiano hacia el este o oeste te
% encuentras, con valores positivas hacia este y negativas hacia el
% oeste.}

% {El lugar lo más conocido por el cual pasa este meridiano es Greenwich,
% una ciudad cerca de Londres en Reino-Unido, casa del Observatorio Royal.
% El mapa de la Figura 23-2 muestra Greenwich y su longitud es 0.0.}

% {}

% {\includegraphics{images/image112.png}}{~}{\includegraphics{images/image63.png}}{~}

% {El Observatorio Real en Greenwich lanza un rayo de luz a lo largo del
% primer meridiano. Longitud varia entre -180 y 180. ~}

% {La
% }{\href{http://www.google.com/url?q=http\%3A\%2F\%2Fwww.appinventor.org\%2FChapter23\%23point_near_the_russianen_dashalaskan_bor\&sa=D\&sntz=1\&usg=AFQjCNEX4p122bb2iXiMhhlqsMpnfeInKA}{Figura
% 23-3}}{~muestra un lugar en Rusia, muy cerca de Alaska, que tiene 180.0
% de longitud. Podrías decir que tal lugar se encuentra a medio camino
% alrededor del mundo desde Greenwich (0.0 longitude).}

% {}

% {\includegraphics{images/image109.png}}{~}

% {Un lugar cerca de la frontera de Rusia y Alaska que tiene una longitud
% de 180.}

% \hyperdef{}{}{\subsection{\texorpdfstring{{Medir ubicación con App
% Inventor}}{Medir ubicación con App Inventor}}}

% {App Inventor viene con el componente }{LocationSensor}{~para acceder a
% información GPS. El componente tiene propiedades para }{Latitude}{,
% }{Longitude}{, y }{Altitude}{.También comunica con Google Maps, para que
% puedas tener una lectura para tu dirección actual.}

% {LocationSensor.LocationChanged}{, mostrado
% en}{\href{http://www.google.com/url?q=http\%3A\%2F\%2Fwww.appinventor.org\%2FChapter23\%23locationsensor1dotlocationchanged_event\&sa=D\&sntz=1\&usg=AFQjCNF_DFT3L2AmqH22WfYqvqUMejx0DA}{~}}{\href{http://www.google.com/url?q=http\%3A\%2F\%2Fwww.appinventor.org\%2FChapter23\%23locationsensor1dotlocationchanged_event\&sa=D\&sntz=1\&usg=AFQjCNF_DFT3L2AmqH22WfYqvqUMejx0DA}{Figura
% 23-4}}{, es el gestionador de evento más importante de
% }{LocationSensor}{.}

% {\includegraphics{images/image05.png}}{~}

% {Figura 23-4. El gestionador de evento LocationSensor1.LocationChanged }

% {}

% {Este evento está activado la primera vez que el sensor tiene una
% lectura y cada vez que el teléfono está movido lo suficiente para que
% nueva data pueda ser leída. Es frecuente tener una demora de algunos
% segundos antes de la primera lectura de una aplicación, y a veces el
% equipo no puede obtener lectura. Por ejemplo, si estás en una pieza
% cerrada y no conectado al WiFi, podría ser que el equipo no obtenga una
% lectura. Tu telefono tambien tiene ajustes que te permiten apagar la
% lectura GPS para ahorrar batería; es otra potencial razón por la cual el
% equipo podría no obtener lectura.}

% {Por estas razones, no tienes que suponer que las propiedades
% }{LocationSensor}{~tienen ajustes validados hasta que el evento
% }{LocationSensor.LocationChanged }{pase.}

% {Una manera de manejar lo desconocido en medición de ubicación es crear
% una variable }{lastKnownLocation (ultimaUbicacionConocida)}{,
% inicializarla a ``desconocida'' (``unknown'') y después hacer que el
% gestionador de evento }{LocationSensor.LocationChanged}{~cambie el valor
% de la variable, como lo muestra la Figura siguiente.}

% {}

% {\includegraphics{images/image104.png}}{Figura 23-5. El valor de la
% variable lastKnownLocation cambia junto con el cambio de ubicación }

% {}

% {Programando el gestionador de evento
% }{LocationSensor.LocationChanged}{~de esta manera, siempre podrás
% mostrar la ubicación actual o registrarla en una base de datos, con
% ``unknown'' (``desconocido'') apareciendo hasta la primera lectura. Esta
% estrategia está utilizada en la aplicación de No Texting mientras
% manejas.}

% {También puedes preguntar explícitamente si el sensor tiene una lectura
% utilizando el block }{LocationSensor.HasLongitudeLatitude}{~(ver
% }{\href{http://www.google.com/url?q=http\%3A\%2F\%2Fwww.appinventor.org\%2FChapter23\%23testing_whether_the_sensor_has_a_reading\&sa=D\&sntz=1\&usg=AFQjCNEwevv6X5vh-FZJRU_Rlfhj6QtNEQ}{Figure
% 23-6}}{).}
...
% {Figura 23-6. Testeando si el sensor tiene una lectura con el block
% HasLongitudeLatitude.}

% \hyperdef{}{}{\subsection{\texorpdfstring{{Averiguando los
% límites}}{Averiguando los límites}}}

% {Un uso común del evento }{LocationChanged}{~es de averiguar si el
% equipo se encuentra dentro de una zona. Por ejemplo, considera el código
% de la Figura 23-7, que hace vibrar el teléfono cada vez que una nueva
% lectura muestra que el usuario se ha movido más lejos que 0.1 de
% longitud desde el primer meridiano.}
...
% {Figura 23-7. Si una lectura no está cerca del primer meridiano, el
% teléfono vibra.}

% {}

% {Tal revisión de límites (zona límite) tiene varias aplicaciones; por
...
% \hyperdef{}{}{\subsection{\texorpdfstring{{Proveedores de información de
% ubicación: GPS, WiFi, y Cell
% ID}}{Proveedores de información de ubicación: GPS, WiFi, y Cell ID}}}
...
% edificio y que hay rascacielos o otros objetos entre ti y los satélites;
% necesitás poder acceder al menos a 3 satélites del sistema.}

% {Si el GPS no está disponible o que el usuario lo ha desactivado, el
% equipo puede obtener su ubicación a través de una red inalámbrica.
% Tienes que estar cerca de un router WiFi y la lectura de ubicación que
